...
RSpec.describe ReportsController, :type => :controller do
  ...
  let(:valid_attributes) { 
    FactoryGirl.build(:stream_report).attributes
  }

  let(:invalid_attributes) {
    {
      "first_name" => "Wally", "last_name" => nil, "previous_year" => false
    }
  }
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) {
        FactoryGirl.build(:lake_report).attributes
      }
      ...
      it "updates the requested report" do
        ...
        report.reload
        assert_equal("Wally", report.first_name)
        assert_equal("Walleye", report.last_name)
      end
